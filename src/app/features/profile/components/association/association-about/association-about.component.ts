...
import { TextareaFieldComponent } from 'src/app/common/components/textarea-field/textarea-field.component';
...
@Component({
  ...
  standalone: true,
  imports: [MultipleInputFieldComponent, TextareaFieldComponent, AssociationStatsComponent, UploadAvatarComponent, AsyncPipe],
